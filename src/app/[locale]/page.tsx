...
export default function Home() {
  ...
  const portfolioItems = [
    ...
    { id: 'wd1', src: wd1, titleKey: 'sections.wd.item1', sectionKey: ' <a href="https://thermal-match.vercel.app/pt" target="_blank" rel="noopener noreferrer" >sections.wd.title</a>' },
